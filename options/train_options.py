...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--validate_freq', type=int, default=10, help='frequency of showing training results on screen')
        ...
        self.parser.add_argument('--display_epoch_freq', type=int, default=10, help='frequency of saving visualizations at the end of epochs')
